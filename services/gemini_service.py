...
{{
    ...
    "map_actions": [
        ...
        {{
            ...
            "dataset_name": "power_lines",  # Either "flood_zones" or "power_lines"
...
IMPORTANT NOTE: Power line data is ONLY available for United States. Even if the user asks about power line risk in
other countries, setting analyze_power_lines=true will only show power lines for US regions.
